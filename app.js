...
var createNewTaskElement=function(taskString){
    ...
    listItem.className="task-list__item task-list__item_style";
    ...
    editInput.type="text";
    editInput.id="new-task";
    editInput.className="article__input article__input_style";

    editButton.innerText="Edit"; //innerText encodes special characters, HTML does not.
    editButton.className="button button_edit";

    deleteButton.className="button button_delete";
    deleteButtonImg.className="button button_delete button__icon"
...
var taskCompleted=function(){
    ...
    var listItem=this.parentNode;
    var label = listItem.querySelector("label");
    label.classList += " task-list__label_style";
